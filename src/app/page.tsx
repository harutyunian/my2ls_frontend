  ...
  return (
    <div className={style.container}>
      ...
      <p>
        ...
        enthusiasts. <br />
        From code editors and JSON processors to converters and formatters,{" "}
        <br />
        our platform offers everything you need to streamline your workflow and
        boost productivity. <br />
        Simplify your tasks with our fast, reliable, and user-friendly tools—all
        in one place!
      </p>
