...
export default function RootLayout({
    ...
    return (
        <html lang="en">
        <Head>
            <title>My2LS - All-in-One Online Tools for Developers and Tech Enthusiasts</title>
            <meta name="keywords"
            ...
            <meta property="og:title" content="My2LS - All-in-One Online Tools for Developers and Tech Enthusiasts"/>
